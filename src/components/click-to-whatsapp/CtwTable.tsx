...
export default function CtwTable({ rows, isLoading, onRowClick,
    onRowDelete, totalRows, currentPage, setCurrentPage, handleSearch }) {
        ...
        <React.Fragment>
            ...
            >
                <FormControl sx={{ flex: 1 }} size="sm">
                    <FormLabel>Search for click to whatsapp</FormLabel>
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: 100, padding: '12px 6px' }}>Click To Whatsapp Name</th>
                            <th style={{ width: 80, padding: '12px 6px' }}>Phone</th>
                            <th style={{ width: 260, padding: '12px 6px' }}>Text</th>
                            <th style={{ width: 30, padding: '12px 6px' }}>Copy URL</th>
                                    ...
                                    />
                                        ...
                                        <td>
                                            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                                ...
                                                <Typography level="body-xs">{row.text}</Typography>
                                        ...
                                        <td>
                                            ...
                                            <IconButton size="sm" color="neutral" component="button">
                                                <CopyAll />
                                            </IconButton>
