...
export default function ChatbotList({ rows, isLoading, onRowClick,
    onRowDelete, totalRows, currentPage, setCurrentPage }) {
                            ...
                            <List key={listItem.id} size="sm" sx={{ '--ListItem-paddingX': 0 }} onClick={() => {
                                ...
                                >
                                    <ListItemContent sx={{ display: 'flex', gap: 2, alignItems: 'start' }}>
                                        ...
                                        <div>
                                            ...
                                            <Box sx={{
                                                ...
                                                <Typography level="body-xs" gutterBottom>{moment(listItem.createdAt).format('MMM D, YYYY')}</Typography>
                                    ...
                                    <>
                                        ...
                                        <RowMenu onRowDelete={onRowDelete} row={listItem} />
                                    </>
                                </ListItem>
                                <ListDivider />
                            </List>
