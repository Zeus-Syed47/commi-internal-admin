...
export default function ChatbotTable({ rows, isLoading, onRowClick,
        ...
        <React.Fragment>
            ...
            >
                <FormControl sx={{ flex: 1 }} size="sm">
                    <FormLabel>Search for chatbot files</FormLabel>
            ...
            >
                ...
                >
                    <thead>
                        <tr>
                            <th style={{ width: 100, padding: '12px 6px' }}>File Name</th>
                                    ...
                                    <tr key={row.id} onClick={() => onRowClick(row)} style={{ cursor: 'pointer' }}>
                                        ...
                                        <td>
                                            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                                ...
                                                <Typography level="body-xs">{JSON.stringify(row.content).slice(0,500)+'...'}</Typography>
