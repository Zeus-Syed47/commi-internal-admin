...
import BroadCastTableSkeleton from './BroadCastTableSkeleton';
...
export default function BroadcastTable({ rows, isLoading, onRowClick, totalRows, currentPage, setCurrentPage, handleSearch, onEdit }) {
