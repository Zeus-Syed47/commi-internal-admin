...
export default function BroadcastRetryList({ rows, isLoading, onRowClick, onEdit, totalRows,
    currentPage, setCurrentPage, onButtonClick, showRetry }) {
