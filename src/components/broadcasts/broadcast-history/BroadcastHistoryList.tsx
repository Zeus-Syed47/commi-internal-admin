...
export default function BroadcastHistoryList({ rows, isLoading, onRowClick,
                                    ...
                                    <ListItemContent sx={{ display: 'flex', gap: 2, alignItems: 'start' }}>
                                        <div>
                                            <Typography gutterBottom sx={{ fontWeight: 600 }}>
                                                {listItem?.conversation?.involved_contact?.name}
                                            </Typography>
                                            <Box sx={{
                                                display: 'flex',
                                                flexDirection: 'row',
                                                ...
                                                <Typography level="body-xs" gutterBottom>
                                                    {listItem?.conversation?.involved_contact?.phone_number}
                                                </Typography>
                                            ...
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                                                ...
                                                >
                                                    {listItem.double_tick_status}
                                                </Chip>
                                                <Typography level="body-xs" textColor='tomato' >
                                                    {listItem?.error_reason}
                                                </Typography>
                                            </Box>
                                        </div>
                                    </ListItemContent>
