...
export default function CreateAI(props: any) {
    ...
    const { companyUsers,
        ...
        isUserUpdating, phone_numbers, isPhonesLoading, virtual_phone_numbers,
        data_sources, handleAIUserInfo, handleAddAiUser,
                                ...
                                <Stack spacing={1}>
                                    ...
                                    >
                                        <Textarea
                                            ...
                                            value={userValues?.system_prompt}
                                            onChange={(e) => updateUserFields({
                                                value: e.target.value,
                                                key: "system_prompt"
                                            })}
