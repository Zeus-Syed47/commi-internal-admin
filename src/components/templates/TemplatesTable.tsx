...
function RowMenu({ onEdit, setOpenDelete, row }) {
    return (
        <Dropdown>
            <MenuButton
...
export default function TemplatesTable({ rows, isLoading,
    onRowClick, totalRows,
    currentPage, setCurrentPage,
    handleSearch, openDelete,
        ...
        <React.Fragment>
            ...
            >
                <FormControl sx={{ flex: 1 }} size="sm">
                    <FormLabel>Search for templates</FormLabel>
                    <Input size="sm" placeholder="Search" startDecorator={<SearchIcon />} onChange={(e) => handleSearch(e.target.value)} />
                </FormControl>
                {/* {renderFilters()} */}
            </Box>
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: 90, padding: '12px 6px' }}>Template name</th>

                            <th style={{ width: 90, padding: '12px 6px' }}>Category</th>
