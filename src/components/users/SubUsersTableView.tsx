...
import UserRow from "./ManagerRow";
import { useMemo } from "react";
import SubUsersRow from "./SubUsersRow";
...
export default function SubUsersTableView(props) {
    const { enableCheckbox, selected, setSelected, isLoading, rows, onEdit, onDelete, order } = props;
