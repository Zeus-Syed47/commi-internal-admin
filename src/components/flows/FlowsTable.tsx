...
export default function FlowTable({ rows, isLoading, onRowClick,
    onRowDelete, setCurrentPage, totalRows, currentPage, handleSearch }) {
        ...
        <React.Fragment>
            ...
            >
                <FormControl sx={{ flex: 1 }} size="sm">
                    <FormLabel>Search for flows</FormLabel>
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: 280, padding: '12px 6px' }}>Flow Name</th>
